...
function Page({ classes, user, currentFullPage }) {
  return (
    ...
    >
      ...
      <Button className={classNames([classes.backButton, currentFullPage !== "map" && classes.hideBackButton])} variant="fab">
        <BackIcon />
      </Button>
      <Button className={classNames([classes.createEventFormButton, currentFullPage !== "map" && classes.hidecreateEventFormButton])} variant="fab">
        <AddIcon />
      </Button>
      <Map />
    </div>
